...
<head>
    ...
    <style>
        ...
        .custom-select {
            ...
            -moz-appearance: none;
            background-image: url('data:image/svg+xml;charset=US-ASCII,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>');
        ...
        <div class="w-full sm:max-w-md px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <input id="ic" class="block mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="ic" value="{{ old('ic') }}" required autofocus pattern="\d{12}" maxlength="12" title="IC must be exactly 12 digits" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 12)" />
                    @error('ic')
                ...
                <div class="mb-4 relative">
                    ...
                    <select id="role" name="role" class="block mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 custom-select">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-container relative">
                        <input id="password" class="block mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="password" name="password" required autocomplete="current-password" />
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route('password.request') }}" class="text-sm text-blue-700 hover:text-blue-900">{{ __('Forgot your password?') }}</a>
