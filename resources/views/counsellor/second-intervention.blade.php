...
<div class="mt-6">
    ...
    <!-- Search Form -->
    <form method="GET" action="{{ route('counsellor.secondIntervention') }}" class="flex items-center space-x-2 mb-6">
        ...
        <a href="{{ route('counsellor.secondIntervention') }}" class="bg-gradient-to-r from-gray-500 to-gray-700 hover:from-gray-600 hover:to-gray-800 text-white px-4 py-2 rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:scale-105">Clear</a>
    </form>
