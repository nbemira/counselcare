            ...
            <div class="p-2">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center justify-between mt-2">
                        ...
                        <!-- Search Form -->
                        <form method="GET" action="{{ route('admin.manage-psychologists') }}" class="flex items-center space-x-2">
                            ...
                            <a href="{{ route('admin.manage-psychologists') }}" class="bg-gradient-to-r from-gray-500 to-gray-700 hover:from-gray-600 hover:to-gray-800 text-white px-4 py-2 rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:scale-105">Clear</a>
                        </form>
                    </div>
                </div>
