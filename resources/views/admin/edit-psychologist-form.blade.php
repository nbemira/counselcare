                    ...
                    <form method="post" action="{{ route('admin.edit-psychologist', ['id' => $psychologist->id]) }}" enctype="multipart/form-data">
                        ...
                        @method('PUT')
                            ...
                            <div class="flex justify-end mt-5 space-x-2">
                                ...
                                <a href="{{ route('admin.manage-psychologists') }}" class="px-4 py-2 w-20 text-gray-500 border border-gray-500 rounded hover:bg-gray-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50">
                                    Cancel
                                </a>
                            </div>
                    </form>
