                ...
                <div class="p-4">
                    ...
                    <form method="post" action="{{ route('admin.add-counsellor') }}" enctype="multipart/form-data">
                        ...
                        <div class="flex justify-end mt-5 space-x-2">
                            ...
                            <button onclick="event.preventDefault(); location.href='{{ route('admin.manage_counsellors') }}';" class="px-4 py-2 w-20 text-gray-500 border border-gray-500 rounded-md hover:bg-gray-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50">
                                Cancel
                            </button>
                        </div>
                    </form>
